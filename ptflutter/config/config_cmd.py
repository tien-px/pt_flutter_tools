...
class ConfigCommand(Command):
    ...
    LOCAL_CONFIG_FILE = "ptflutter.config"

    KEY_VALUES = {
        "project.package_name": "str",
        "localization.input_path": "str",
        "localization.output_path": "str",
        "localization.file_name": "str",
    }
    ...
    def update_project_info(self):
        ...
        bundle_name = input('Enter bundle name  (e.g. com.example.flutter_app):')
